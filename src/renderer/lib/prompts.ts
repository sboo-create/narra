  ...
  return [
    {
      role: 'system',
      content:
        'Составь саммари главы: 3–5 предложений, охвати события ВСЕЙ главы — от начала до конца, ' +
        'включая финал. Только суть, без воды и оценок. По-русски. Верни только текст саммари.'
    },
    { role: 'user', content: `Глава «${title}» (полный текст):\n${chapterText.slice(0, 30000)}\n\nСаммари всей главы:` }
  ]
}
...
{"scene":"что происходит, где, время суток, настроение — одной фразой до 30 слов","people":[{"id":"...","action":"поза и действие персонажа сейчас, коротко","outfit":"одежда, ТОЛЬКО если описана в этом фрагменте, иначе null"}],"extras":[{"name":"имя героя, которого НЕТ в списке, но он физически в кадре","look":"его внешность: возраст, волосы, глаза, одежда — из текста или по канону вселенной"}]}
Правила:
...
- extras — для тех, кто в кадре, но отсутствует в списке (эпизодические, преподаватели, родня). Для известных вселенных описывай их каноничной внешностью (напр. Снейп — худой мужчина за 30, чёрные сальные волосы до плеч, чёрные глаза, крючковатый нос, чёрная мантия). Если таких нет — пустой массив.`
    },
